// Store data and shared utilities
const storeData = {
  "store": {
    "name": "Laksh's Store",
  ...
  "categories": [
    {
      ...
      "sampleProducts": [
        { "name": "Basmati Rice", "price": 80, "unit": "kg" },
    ...
    },
    {
      ...
      "sampleProducts": [
        { "name": "Lays Classic", "price": 20, "unit": "pack" },
        { "name": "Kurkure", "price": 15, "unit": "pack" },
        { "name": "Popcorn", "price": 25, "unit": "pack" }
      ]
    },
    {
      "id": "beauty",
      ...
      "sampleProducts": [
        { "name": "Face Wash (Himalaya)", "price": 85, "unit": "bottle" },
        { "name": "Soap (Dove)", "price": 45, "unit": "bar" },
        { "name": "Shampoo (Pantene)", "price": 160, "unit": "bottle" }
      ]
    },
    {
      "id": "beverages",
      ...
      "sampleProducts": [
        { "name": "Coca Cola (500ml)", "price": 35, "unit": "bottle" },
        { "name": "Mango Juice", "price": 40, "unit": "bottle" },
        { "name": "Tea", "price": 120, "unit": "pack" }
      ]
    },
    {
      "id": "biscuits",
      ...
      "sampleProducts": [
        { "name": "Parle-G", "price": 12, "unit": "pack" },
        { "name": "Oreo", "price": 25, "unit": "pack" },
        { "name": "Good Day", "price": 30, "unit": "pack" }
      ]
    },
    {
      "id": "household",
      ...
      "sampleProducts": [
        { "name": "Detergent Powder", "price": 85, "unit": "kg" },
        { "name": "Dishwash Liquid", "price": 65, "unit": "bottle" },
        { "name": "Tissue Papers", "price": 45, "unit": "pack" }
      ]
    }
  ],
  "products": [
